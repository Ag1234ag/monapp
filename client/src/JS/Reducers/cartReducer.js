import { GET_CART_LOAD, GET_CART_SUCESS, GET_CART_FAIL , ADD_CART_FAIL ,ADD_CART_SUCESS
,DELETE_CART_SUCESS , DELETE_CART_FAIL } from '../ActionTypes/CartTypes';
const initState = {
  // cart: null,
  // loading: false,
  cartToFind: [],
