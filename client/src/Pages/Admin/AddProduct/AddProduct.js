...
<div className="split-screen">
    ...
    <div className="right">
        ...
        <div className="input-container name">
            ...
            <input id="Category" onChange={handleChange} name="Category" type="text" />
        </div>
        <div className="input-container name">
            <label for="Barcode">Barcode</label>
            <input id="Barcode" onChange={handleChange} name="Barcode" type="text" />
        </div>
        <div className="input-container name">
        ...
        <div className="input-container name">
            ...
            <input id="Size" onChange={handleChange} name="Size" type="text" />
        </div>
        <div className="input-container name">
